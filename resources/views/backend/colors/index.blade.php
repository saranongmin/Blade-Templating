        ...
        <div class="card-header py-3">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <a href="{{ route('colors.create') }}" class="btn btn-sm btn-outline-primary">Add New</a>
                </div>
            </div>
        </div>
        <div class="card-body">
...
{{--                id="dataTable"--}}
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>{{ $color->name }}</td>
                        <td>
                            <a href="{{ route('colors.show', $color->id) }}" class="btn btn-sm btn-outline-info">Show</a>
                            <a href="{{ route('colors.edit', $color->id) }}" class="btn btn-sm btn-outline-warning">Edit</a>
